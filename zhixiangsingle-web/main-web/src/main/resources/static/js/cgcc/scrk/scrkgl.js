...
var ajaxSCJCXXSearchFormOption = {
    ...
    url: "/warehouseDetails/getWarehouseDetailsList",
    type: "post",
...
$(function(){
    ...
    loadCurrentPageStyle("采购仓储","食材入库管理");
            ...
            if(data.result!=null){
                ...
                $.each(data.result,function (ind,val) {
                    if(val){
                        ...
                        var batchNum = "";
                        var delBatchNum = "";
                        if(val.batchNum&&val.batchNum!=''){
                            batchNum = '-HP'+val.batchNum+":";
                            delBatchNum = '-HP'+val.batchNum;
                        }
                        var ctTime = '';
                        if(val.ctTime&&val.ctTime!=''){
                            ctTime = val.ctTime;
                        }
                        var accountInfo
                        if(val.accountInfo&&val.accountInfo!=''){
                            accountInfo = "由"+val.accountInfo
                        }
                        var ingredientName = '';
                        if(val.ingredientName&&val.ingredientName!=''){
                            ingredientName = "验收"+val.ingredientName;
                        }
                        ...
                        if(val.productionDate){
                            productionDate = val.productionDate+"生产";
                        }
                        var inventoryTimeHour = '';
                        if(val.inventoryTimeHour){
                            inventoryTimeHour = val.inventoryTimeHour+"到期,";
                        }
                        var supplierName = '';
                        if(val.supplierName&&val.supplierName!=''){
                            supplierName = "从"+val.supplierName+"购入";
                        }
                        var conStr = '';
                        var meteringName = '';
                        var meteringNameGX = '';
                        var ggxh = '';
                        if(val.ggxh&&val.ggxh!=''&&val.ggxhDW&&val.ggxhDW!=''&&val.meteringName&&val.meteringName!=''){
                            conStr = ",以"+val.ggxh+ val.ggxhDW+"/"+val.meteringName+"的价格"+supplierName+",";
                        }else{
                            conStr = supplierName+",";
                        }
                        var whName = '';
                        if(val.whName&&val.whName!=''){
                            whName = "指定存储于"+val.whName;
                        }

                        comInfoTopStr = cgId+batchNum+ctTime+accountInfo+ingredientName+cName+productionDate+inventoryTimeHour+conStr+whName;
                        /*val.foodPictures = "http://127.0.0.1:100/hhp_zhixiang_img/2019/09/19/10/46/12/2437b42c-21bd-4594-bf95-54d3db7575eb.png,http://127.0.0.1:100/hhp_zhixiang_img/2019/09/19/10/46/12/2437b42c-21bd-4594-bf95-54d3db7575eb.png";
                        val.notePictures = "http://127.0.0.1:100/hhp_zhixiang_img/2019/09/19/10/46/12/2437b42c-21bd-4594-bf95-54d3db7575eb.png," +
                            "http://127.0.0.1:100/hhp_zhixiang_img/2019/09/19/10/46/12/2437b42c-21bd-4594-bf95-54d3db7575eb.png," +
                            "http://127.0.0.1:100/hhp_zhixiang_img/2019/09/19/10/46/12/2437b42c-21bd-4594-bf95-54d3db7575eb.png," +
                            "http://127.0.0.1:100/hhp_zhixiang_img/2019/09/19/10/46/12/2437b42c-21bd-4594-bf95-54d3db7575eb.png";
                        val.certificateOfSoundness = "http://127.0.0.1:100/hhp_zhixiang_img/2019/09/19/10/46/12/2437b42c-21bd-4594-bf95-54d3db7575eb.png," +
                            "http://127.0.0.1:100/hhp_zhixiang_img/2019/09/19/10/46/12/2437b42c-21bd-4594-bf95-54d3db7575eb.png," +
                            "http://127.0.0.1:100/hhp_zhixiang_img/2019/09/19/10/46/12/2437b42c-21bd-4594-bf95-54d3db7575eb.png";*/
                        imgJson["0"] = {
                            imgPath:val.foodPictures,
                            picturePrefix:val.picturePrefix,
                            siteName:val.siteName,
                            sitePhoto:val.sitePhoto,
                            pictureName:"食材"
                        }
                        imgJson["1"] = {
                            imgPath:val.notePictures,
                            picturePrefix:val.picturePrefix,
                            siteName:val.siteName,
                            sitePhoto:val.sitePhoto,
                            pictureName:"票据"
                        ...
                        imgJson["2"] = {
                            imgPath:val.certificateOfSoundness,
                            picturePrefix:val.picturePrefix,
                            siteName:val.siteName,
                            sitePhoto:val.sitePhoto,
                            pictureName:"索证合格证"
                        }
                        var ibImgPath = getManyPictureByJson(imgJson);
                        ...
                        $("#userListUl").append("<div class='col-md-3 col-sm-3 col-xs-12' onclick='checkPurchase(this)'>" +
                            ...
                            "<div class='tpl-table-images-content-i-time-hhp' style='height: 7.5em;-webkit-line-clamp:5;' data-toggle2='tooltip' title='"+comInfoTopStr+"' data-original-title='"+comInfoTopStr+"'>"+comInfoTopStr+"</div>" +
                            ...
                            /*"<div class='tpl-i-font' style='height: 3em;' data-toggle2='tooltip' title='' data-original-title=''>"  +
                            "</div>" +*/
                            ...
                            "<button type='button' class='am-btn am-btn-default am-btn-danger' style='width: 100% !important;' onclick='delRole("+val.id+","+val.sdId+","+"\""+delBatchNum+"\")'><i class='iconfont iconshanchutishi'></i> 删除</button>" +
                            "</div>" +
                            "</div>" +
                            "</div>" +
                            "</div>" +
